        ...
        <div>
            ...
            <div className="container mx-auto max-w-[1140px] pb-[73px]">
                ...
                <div className="shadow-[0px_16px_42.7px_0px_rgba(0,0,0,0.08)] rounded-xl max-w-[786px] h-[358px] mx-auto p-4 mt-[34px]">
                    ...
                    <label htmlFor="image">
                        <div className="py-10 px-10 w-full h-full border border-dashed border-[#ED1C24] rounded-lg flex flex-col items-center justify-center cursor-pointer"
                            onDragOver={HandelDragOver} onDrop={HandelDrag}>
                                ...
                                <p className="text-[#0D0D0D]/40 ff-inter leading-[150%]">WAR, ZIP or EAR, file size no more than 10MB</p>
                        </div>
                    </label>
                    <div className="mt-4">
